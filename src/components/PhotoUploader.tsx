  ...
  return (
    <div className="mb-4 flex flex-col items-center justify-center">
        ...
        <div className="bg-slate-700 rounded-full h-32 w-32 m b-40">
          <label htmlFor="edit-file">
            <picture className="relative">
              ...
              <img className="rounded-full h-32 w-32 hover:opacity-80 hover:cursor-pointer" src={url} alt={`the photo you just uploaded`} />
            </picture>
      ...
      {!url && <div className="flex items-center justify-center w-full">
        <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-80 h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
